...
btnpi = Button(calc, text=chr(928), width=6, height=2, font=('arial',20,'bold'), bd =4, bg="powder blue",
...
btn2pi = Button(calc, text="2"+chr(928), width=6, height=2, font=('arial',20,'bold'), bd =4,bg="powder blue",
...
btnasinh= Button(calc, text="asinh", width=6, height=2, font=('arial',20,'bold'), bd =4,
                  bg="powder blue",command =added_value.sinh).grid(row=4 ,column=7, pady=1)
...
btnLoglp = Button(calc, text="loglp", width=6, height=2, font=('arial',20,'bold'), bd =4,
